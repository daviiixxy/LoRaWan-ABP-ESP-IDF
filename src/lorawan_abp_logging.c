...
void lorawan_abp_log_init(void)
{
    ...
    xTaskCreate(loggingTask, "lorawan_abp_log", 1024 * 4, ringBuffer, 4, NULL);
...
{
    lorawan_abp_log_event(-3, file, line);
}
...
{
    lorawan_abp_log_event(-1, pMessage, 0);
}
...
{
    lorawan_abp_log_event(-2, pMessage, datum);
}
